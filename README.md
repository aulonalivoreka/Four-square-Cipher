...
``` 
You can also run the script by cloning this repository and running it in the code compiler of choice, like Visual Studio Code or an online python compiler like <a href="https://www.programiz.com/python-programming/online-compiler/#google_vignette">Programiz</a>. 
